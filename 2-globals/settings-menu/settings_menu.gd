...
@onready var hover_sfx = preload("res://0-assets/sfx/button/hovered.ogg")
@onready var pressed_sfx = preload("res://0-assets/sfx/button/pressed.ogg")

const MAIN_PATH = "res://1-main/Main.tscn"
...
func _ready() -> void:
	...
	CLogger.info("Initialized SettingsMenu")
...
func toggleMenu() -> void:
	if visible:
		AudiManny.playSFX(pressed_sfx)
		CLogger.action("Closed Settings")
	else:
		AudiManny.playSFX(hover_sfx)
